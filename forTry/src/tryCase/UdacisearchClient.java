...
public final class UdacisearchClient{
    ...
    public static final class Builder{//Builder is static inner class, static!!! look inner class!!!
        private String name = "";//can be initialized inside the Builder!!!
        private long id = 0;
        ...
        //no constructor for BUilder class!!!!
        public UdacisearchClient build(){//remember public
    ...
    public String toString() {
        return "tryCase.UdacisearchClient{" +
                "name='" + getName() + '\'' +
                ", id=" + getId() +
